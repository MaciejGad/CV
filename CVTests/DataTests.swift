...
//        try data.save(to: "cv")
    ...
    func createCV() -> CV {
        ...
        let projects:[Project] = [
            Project(name: "Staff Management App", time: 19 * TimeInterval.month, role: "iOS Developer", technologies: ["Swift", "Firebase", "Push Notifications", "oAuth2", "PromiseKit", "Unit Tests", "UI Tests"], note: "Staff Management App for UK-based company, about 60% of unit test code coverage, extended UI integration tests", link: nil)
        ]
